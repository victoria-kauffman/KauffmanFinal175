...
public class MeshGenerator : MonoBehaviour {
    ...
    private void Start() {
        ...
        oceanMaterial.SetTexture("_DispCA", wavesGenerator.cascade0.Disp);
        oceanMaterial.SetTexture("_DerivCA", wavesGenerator.cascade0.Deriv);
        oceanMaterial.SetTexture("_TurbCA", wavesGenerator.cascade0.Turb);

        oceanMaterial.SetTexture("_DispCB", wavesGenerator.cascade1.Disp);
        oceanMaterial.SetTexture("_DerivCB", wavesGenerator.cascade1.Deriv);
        oceanMaterial.SetTexture("_TurbCB", wavesGenerator.cascade1.Turb);

        oceanMaterial.SetTexture("_DispCC", wavesGenerator.cascade2.Disp);
        oceanMaterial.SetTexture("_DerivCC", wavesGenerator.cascade2.Deriv);
        oceanMaterial.SetTexture("_TurbCC", wavesGenerator.cascade2.Turb);
    ...
    void UpdateMaterials() {
        if (updateMatProp && !showMaterialLods) {
            for (int i = 0; i < 3; i++)
            {
